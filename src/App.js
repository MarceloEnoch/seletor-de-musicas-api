...
const $artista = document.getElementById("input_artista");
...
const limparArtista = () =>{
    console.log("func limparArtista acessada!")
...
const letraMusica = (musica) =>{
    ...
    console.log("essa é a musica: "+musica);
...
const eventos = () =>{
    ...
    // Selecionar musica da tabela de musicas no click
